...
// Test.assertEquals(findInArray([], trueIfEven) , -1)
// Test.assertEquals(findInArray([1,3,5,6,7], trueIfEven) , 3)
// Test.assertEquals(findInArray([2,4,6,8], trueIfEven) , 0)
// Test.assertEquals(findInArray([2,4,6,8], neverTrue) , -1)
// Test.assertEquals(findInArray([13,5,3,1,4,5], trueIfValueEqualsIndex) , 4)
// Test.assertEquals(findInArray(["one","two","three","four","five","six"], trueIfLengthEqualsIndex) , 4)
// Test.assertEquals(findInArray(["bc","af","d","e"], trueIfLengthEqualsIndex) , -1)
